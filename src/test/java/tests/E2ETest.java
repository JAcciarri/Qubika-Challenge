...
public class E2ETest extends BaseTest {
    ...
    public void testEndToEnd(Map<String, String> testData) {
        ...
        step("──── 1) Starting E2E test: Creating user via API");
        ...
        step("──── 2-3) Opening login page and verifying header and inputs");
        loginPage.open();
        ...
        step("──── 4-5) Logging in with created user and verifying sidebar elements");
        ...
        step("──── 6b) Navigating to Category Types and creating a new category");
        ...
        step("──── 6c) Creating a sub-category under the created category");
